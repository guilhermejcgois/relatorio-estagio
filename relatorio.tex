...
No decorrer do projeto, a base de código cresce e fica cada vez mais complexa, para tentar contornar essas situações e mitigar possíveis problemas futuros lá na frente, a adoção de novas tecnologias se faz necessário, como foi e está sendo o caso do GulpJS, conforme vai crescendo o número de componentes da interface, usando GulpJS podemos definir uma tarefa para tratar todos os componentes já existentes e os novos que vierem a surgir, sem falar em outros processos como minificação (técnica empregada para comprimir arquivos CSS e JavaScript) e \textit{lint} (análise estática de código).
